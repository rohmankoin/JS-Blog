...
}( this, function( pluginName )
{
	...
	var throttleTO		= 250,scriptUrl= 'https://www.mankoin.blog/feeds/posts/default?v=2&q=label:"Cara"|label:"Internet"|label:"Windows"|&alt=json&callback=relatedposts&max-results=100', scriptUrl1= 'https://www.mankoin.blog/feeds/posts/default?v=2&alt=json&callback=recentposts&max-results=4',
		scriptLoaded	= false
		...
		initAds = function()
		{
			...
			adsToLoad.forEach( function( ad )
			{
				...
				{
					scriptLoaded = true;
					loadScript( scriptUrl,related_posts());
					loadScript( scriptUrl1);
				}
			});
		},
		resizeAds = function()
	...
	window.addEventListener( 'scroll', throttle( throttleTO, initPos ));
